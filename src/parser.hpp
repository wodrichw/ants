...
public:
  ...
  struct CommandConfig {
    ...
    CommandConfig(
        ...
        std::function<CommandParser(EngineInteractor &interactor, Operations &)>
            assemble)
...
private:
  void parse(EngineInteractor &interactor, Operations &operations,
             std::vector<std::string> &program_code);

public:
  // Methods to parse commands
  static CommandParser parse_move(EngineInteractor &interactor,
                                  Operations &operations);
  static CommandParser parse_jmp(EngineInteractor &interactor,
                                 Operations &operations);
