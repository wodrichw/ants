...
void set_mouse_type(SDL_MouseButtonEvent const& event,
    ...
    SPDLOG_DEBUG("Getting mouse event: x={}, y={}, button={}", event.x, event.y,
                 event.button);
...
KeyboardEventType get_keyboard_type(SDL_Keycode event) {
    switch(event) {
        ...
        case SDLK_z:
            return Z_KEY_EVENT;
        case SDLK_LEFT:
            return LEFT_KEY_EVENT;
        case SDLK_RIGHT:
            return RIGHT_KEY_EVENT;
        case SDLK_UP:
            return UP_KEY_EVENT;
        case SDLK_DOWN:
            return DOWN_KEY_EVENT;
        case SDLK_RETURN:
            return RETURN_KEY_EVENT;
        case SDLK_BACKSPACE:
            return BACKSPACE_KEY_EVENT;
        case SDLK_SPACE:
            return SPACE_KEY_EVENT;
        case SDLK_COLON:
            return COLON_KEY_EVENT;
        case SDLK_BACKSLASH:
            return BACK_SLASH_KEY_EVENT;
        case SDLK_0:
            return ZERO_KEY_EVENT;
        case SDLK_1:
            return ONE_KEY_EVENT;
        case SDLK_2:
            return TWO_KEY_EVENT;
        case SDLK_3:
            return THREE_KEY_EVENT;
        case SDLK_4:
            return FOUR_KEY_EVENT;
        case SDLK_5:
            return FIVE_KEY_EVENT;
        case SDLK_6:
            return SIX_KEY_EVENT;
        case SDLK_7:
            return SEVEN_KEY_EVENT;
        case SDLK_8:
            return EIGHT_KEY_EVENT;
        case SDLK_9:
            return NINE_KEY_EVENT;
        default:
            return UNKNOWN_KEY_EVENT;
    }
}

void set_keyboard_type(SDL_Keysym const& event, KeyboardEvent& keyboard_event) {
    SPDLOG_DEBUG("Setting keyboard event: key={}, mod={}", event.sym,
                 event.mod);
...
void unset_keyboard_chord_type(SDL_Keysym const& event,
                               KeyboardChordEvent& keyboard_event) {
    SPDLOG_DEBUG("Unsetting keyboard event: key={}, mod={}", event.sym,
                 event.mod);
