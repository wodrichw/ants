...
GameState::GameState(Mode* primary_mode, Mode* editor_mode)
    : mode(primary_mode), primary_mode(primary_mode), editor_mode(editor_mode) {
    mode->on_start();
}
